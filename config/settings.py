...
SECRET_KEY = 'django-insecure-_1qf^c**!^mwc(#jkr8o^dih1=k5!%ui_=lz90v4u2co+))u59'
...
INSTALLED_APPS = [
    ...
    #jwt
    'rest_framework_simplejwt.token_blacklist',  # for refresh token blacklist
    'rest_framework',
    'users',
...
SIMPLE_JWT = {
    ...
    "ALGORITHM": "HS256",
    "SIGNING_KEY": SECRET_KEY,                      # default, can use env
...
EMAIL_PORT = 587
EMAIL_USE_TLS = True
EMAIL_HOST_USER = 'osmangani1osm@gmail.com'
EMAIL_HOST_PASSWORD = 'mjuk ubte fhxn gptv'
